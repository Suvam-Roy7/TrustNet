...
import com.social.NotificationService.Event.CommentCreatedEvent;

@Configuration
public class CommentCreatedKafkaConsumerConfig {
	...
	public ConsumerFactory<String, CommentCreatedEvent> commentCreatedConsumerFactory(
		...
		properties.put(ConsumerConfig.GROUP_ID_CONFIG, "notification-service-comment-created");

		properties.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

		properties.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false);

		JsonDeserializer<CommentCreatedEvent> deserializer = new JsonDeserializer<>(CommentCreatedEvent.class);
	...
	@Bean(name = "commentCreatedKafkaListenerContainerFactory")
	public ConcurrentKafkaListenerContainerFactory<String, CommentCreatedEvent> commentCreatedKafkaListenerContainerFactory(

			ConsumerFactory<String, CommentCreatedEvent> commentCreatedConsumerFactory,
